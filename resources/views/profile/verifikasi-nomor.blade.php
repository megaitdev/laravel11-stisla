                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body ">
                                <div class="login-brand">
                                    <img src="{{ asset('gif/email-send.gif') }}" alt="logo" width="75">
                                </div>
                                <p class="text-muted text-center">We've sent a code to
                                    <strong class="text-dark">{{ $user->nomor_wa }}</strong>
                                </p>
                                ...
                                <div class="form-group mb-2">
                                    <button onclick="javascript:verifikasi()" class="btn btn-success btn-lg btn-block">
                                        Submit
                                    </button>
